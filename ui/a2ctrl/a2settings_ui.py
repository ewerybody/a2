...
#
# Created: Tue Aug 23 09:33:11 2016
...
class Ui_a2settings(object):
    def setupUi(self, a2settings):
        ...
        self.formLayout_2.setWidget(7, QtGui.QFormLayout.FieldRole, self.settings_folder)
        ...
        self.formLayout_2.setWidget(8, QtGui.QFormLayout.FieldRole, self.module_folder)
        ...
        self.formLayout_2.setWidget(2, QtGui.QFormLayout.FieldRole, self.ahk_exe)
        self.code_editor = PathField(self.dev_widget)
        self.code_editor.setObjectName("code_editor")
        self.formLayout_2.setWidget(3, QtGui.QFormLayout.FieldRole, self.code_editor)
        ...
        self.formLayout_2.setWidget(4, QtGui.QFormLayout.FieldRole, self.loglevel_debug)
        self.spinBox = QtGui.QSpinBox(self.dev_widget)
        self.spinBox.setMaximumSize(QtCore.QSize(70, 16777215))
        self.spinBox.setObjectName("spinBox")
        self.formLayout_2.setWidget(5, QtGui.QFormLayout.FieldRole, self.spinBox)
    ...
    def retranslateUi(self, a2settings):
        ...
        self.label_10.setText(QtGui.QApplication.translate("a2settings", "Verbose Logging:", None, QtGui.QApplication.UnicodeUTF8))
