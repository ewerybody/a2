...
#
# Created: Fri Oct 20 21:10:17 2017
...
class Ui_Keyboard(object):
    def setupUi(self, Keyboard):
        ...
        self.num_lock_key = QtGui.QPushButton(self.num_block_widget)
        self.num_lock_key.setObjectName("num_lock_key")
        self.gridLayout_3.addWidget(self.num_lock_key, 1, 0, 1, 1)
        self.num_slash_key = QtGui.QPushButton(self.num_block_widget)
        self.num_slash_key.setObjectName("num_slash_key")
        self.gridLayout_3.addWidget(self.num_slash_key, 1, 1, 1, 1)
        self.num_asterisk_key = QtGui.QPushButton(self.num_block_widget)
        self.num_asterisk_key.setObjectName("num_asterisk_key")
        self.gridLayout_3.addWidget(self.num_asterisk_key, 1, 2, 1, 1)
        self.num_minus_key = QtGui.QPushButton(self.num_block_widget)
        self.num_minus_key.setObjectName("num_minus_key")
        self.gridLayout_3.addWidget(self.num_minus_key, 1, 3, 1, 1)
        self.num_7_key = QtGui.QPushButton(self.num_block_widget)
        self.num_7_key.setObjectName("num_7_key")
        self.gridLayout_3.addWidget(self.num_7_key, 2, 0, 1, 1)
        self.num_8_key = QtGui.QPushButton(self.num_block_widget)
        self.num_8_key.setObjectName("num_8_key")
        self.gridLayout_3.addWidget(self.num_8_key, 2, 1, 1, 1)
        self.num_9_key = QtGui.QPushButton(self.num_block_widget)
        self.num_9_key.setObjectName("num_9_key")
        self.gridLayout_3.addWidget(self.num_9_key, 2, 2, 1, 1)
        self.num_plus_key = QtGui.QPushButton(self.num_block_widget)
        self.num_plus_key.setObjectName("num_plus_key")
        self.gridLayout_3.addWidget(self.num_plus_key, 2, 3, 2, 1)
        self.num_4_key = QtGui.QPushButton(self.num_block_widget)
        self.num_4_key.setObjectName("num_4_key")
        self.gridLayout_3.addWidget(self.num_4_key, 3, 0, 1, 1)
        self.num_5_key = QtGui.QPushButton(self.num_block_widget)
        self.num_5_key.setObjectName("num_5_key")
        self.gridLayout_3.addWidget(self.num_5_key, 3, 1, 1, 1)
        self.num_6_key = QtGui.QPushButton(self.num_block_widget)
        self.num_6_key.setObjectName("num_6_key")
        self.gridLayout_3.addWidget(self.num_6_key, 3, 2, 1, 1)
        self.num_1_key = QtGui.QPushButton(self.num_block_widget)
        self.num_1_key.setObjectName("num_1_key")
        self.gridLayout_3.addWidget(self.num_1_key, 4, 0, 1, 1)
        self.num_2_key = QtGui.QPushButton(self.num_block_widget)
        self.num_2_key.setObjectName("num_2_key")
        self.gridLayout_3.addWidget(self.num_2_key, 4, 1, 1, 1)
        self.num_3_key = QtGui.QPushButton(self.num_block_widget)
        self.num_3_key.setObjectName("num_3_key")
        self.gridLayout_3.addWidget(self.num_3_key, 4, 2, 1, 1)
        self.num_enter_key = QtGui.QPushButton(self.num_block_widget)
        self.num_enter_key.setObjectName("num_enter_key")
        self.gridLayout_3.addWidget(self.num_enter_key, 4, 3, 2, 1)
        self.num_0_key = QtGui.QPushButton(self.num_block_widget)
        self.num_0_key.setObjectName("num_0_key")
        self.gridLayout_3.addWidget(self.num_0_key, 5, 0, 1, 2)
        self.num_dot_key = QtGui.QPushButton(self.num_block_widget)
        self.num_dot_key.setObjectName("num_dot_key")
        self.gridLayout_3.addWidget(self.num_dot_key, 5, 2, 1, 1)
