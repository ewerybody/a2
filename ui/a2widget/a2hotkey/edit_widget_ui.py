...
class Ui_edit:
    ...
    def retranslateUi(self, edit):
        ...
        self.cfg_name.setText(QCoreApplication.translate('edit', 'extensionX_hotkey1', None))
        self.displayLabelLabel.setText(QCoreApplication.translate('edit', 'display label:', None))
        self.cfg_label.setText(QCoreApplication.translate('edit', 'make some awesome stuff', None))
        self.hotkeyLabel.setText(QCoreApplication.translate('edit', 'hotkey:', None))
        self.cfg_disablable.setText(QCoreApplication.translate('edit', 'can be disabled', None))
        self.cfg_scopeChange.setText(QCoreApplication.translate('edit', 'allow scope change', None))
        self.cfg_enabled.setText(QCoreApplication.translate('edit', 'enabled by default', None))
        self.cfg_keyChange.setText(QCoreApplication.translate('edit', 'allow key change', None))
        self.cfg_multiple.setText(QCoreApplication.translate('edit', 'allow multiple hotkeys', None))
        self.functionLabel.setText(QCoreApplication.translate('edit', 'function:', None))
