...
class Ui_Mouse:
    def setupUi(self, Mouse):
        ...
        self.lbutton.setToolTip(u"Left Mouse Button")
        self.lbutton.setText(u"L")
        ...
        self.wheelleft.setToolTip(u"Wheel Left")
        ...
        self.wheelup.setToolTip(u"Wheel Up")
        ...
        self.mbutton.setToolTip(u"Middle Mouse Button")
        self.mbutton.setText(u"M")
        ...
        self.wheeldown.setToolTip(u"Wheel Down")
        ...
        self.wheelright.setToolTip(u"Wheel Right")
        ...
        self.rbutton.setToolTip(u"Right Mouse Button")
        self.rbutton.setText(u"R")
