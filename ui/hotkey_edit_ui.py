...
class Ui_hotkey_edit(object):
    def setupUi(self, hotkey_edit):
        ...
        self.functionComboBox = QtGui.QComboBox(self.groupBox)
        self.functionComboBox.setObjectName("functionComboBox")
        self.functionComboBox.addItem("")
        self.functionComboBox.addItem("")
        self.functionComboBox.addItem("")
        self.functionRowLayout.addWidget(self.functionComboBox)
    ...
    def retranslateUi(self, hotkey_edit):
        ...
        self.functionComboBox.setItemText(0, QtGui.QApplication.translate("hotkey_edit", "run code", None, QtGui.QApplication.UnicodeUTF8))
