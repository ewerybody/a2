...
class Property(object):
    ...
    def __init__(self, type:type, fget:Optional[Callable]=..., fset:Optional[Callable]=..., freset:Optional[Callable]=..., fdel:Optional[Callable]=..., doc:str=..., notify:Optional[Callable]=..., designable:bool=..., scriptable:bool=..., stored:bool=..., user:bool=..., constant:bool=..., final:bool=...) -> Property: ...
...
class PyClassProperty(property):
    ...
    @classmethod
    def __init__(cls, fget:Optional[Callable[[Any], Any]]=..., fset:Optional[Callable[[Any, Any], NoneType]]=..., fdel:Optional[Callable[[Any], NoneType]]=..., doc:Optional[str]=...) -> PyClassProperty: ...
...
class QAbstractEventDispatcher(QObject):
    ...
    def filterNativeEvent(self, eventType:Union[QByteArray, bytes], message:int) -> Tuple[bool, int]: ...
...
class QAbstractItemModel(QObject):
    ...
    def beginMoveColumns(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceFirst:int, sourceLast:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationColumn:int) -> bool: ...
    def beginMoveRows(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceFirst:int, sourceLast:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationRow:int) -> bool: ...
    ...
    def changePersistentIndex(self, from_:Union[QModelIndex, QPersistentModelIndex], to:Union[QModelIndex, QPersistentModelIndex]) -> None: ...
    def changePersistentIndexList(self, from_:List[int], to:List[int]) -> None: ...
    def checkIndex(self, index:Union[QModelIndex, QPersistentModelIndex], options:QAbstractItemModel.CheckIndexOptions=...) -> bool: ...
    ...
    def decodeData(self, row:int, column:int, parent:Union[QModelIndex, QPersistentModelIndex], stream:QDataStream) -> bool: ...
    ...
    def insertColumn(self, column:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    ...
    def match(self, start:Union[QModelIndex, QPersistentModelIndex], role:int, value:Any, hits:int=..., flags:Qt.MatchFlags=...) -> List[int]: ...
    def mimeData(self, indexes:List[int]) -> QMimeData: ...
    def mimeTypes(self) -> List[str]: ...
    def moveColumn(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceColumn:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationChild:int) -> bool: ...
    def moveColumns(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceColumn:int, count:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationChild:int) -> bool: ...
    def moveRow(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceRow:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationChild:int) -> bool: ...
    def moveRows(self, sourceParent:Union[QModelIndex, QPersistentModelIndex], sourceRow:int, count:int, destinationParent:Union[QModelIndex, QPersistentModelIndex], destinationChild:int) -> bool: ...
    @overload
    def parent(self) -> QObject: ...
    @overload
    def parent(self, child:Union[QModelIndex, QPersistentModelIndex]) -> QModelIndex: ...
    def persistentIndexList(self) -> List[int]: ...
    def removeColumn(self, column:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    def removeColumns(self, column:int, count:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    ...
    def sibling(self, row:int, column:int, idx:Union[QModelIndex, QPersistentModelIndex]) -> QModelIndex: ...
...
class QAbstractNativeEventFilter(Shiboken.Object):
    ...
    def nativeEventFilter(self, eventType:Union[QByteArray, bytes], message:int) -> Tuple[object, int]: ...
...
class QByteArray(Shiboken.Object):
    ...
    @staticmethod
    def fromBase64(base64:Union[QByteArray, bytes], options:QByteArray.Base64Options=...) -> QByteArray: ...
    @staticmethod
    def fromBase64Encoding(base64:Union[QByteArray, bytes], options:QByteArray.Base64Options=...) -> QByteArray.FromBase64Result: ...
    @staticmethod
    def fromHex(hexEncoded:Union[QByteArray, bytes]) -> QByteArray: ...
    @staticmethod
    def fromPercentEncoding(pctEncoded:Union[QByteArray, bytes], percent:int=...) -> QByteArray: ...
    @staticmethod
    ...
    @overload
    def replace(self, before:Union[QByteArray, bytes], after:Union[QByteArray, bytes]) -> QByteArray: ...
    @overload
    ...
    def toPercentEncoding(self, exclude:Union[QByteArray, bytes]=..., include:Union[QByteArray, bytes]=..., percent:int=...) -> QByteArray: ...
...
class QCalendar(Shiboken.Object):
    ...
    def dateTimeToString(self, format:str, datetime:QDateTime, dateOnly:QDate, timeOnly:QTime, locale:Union[QLocale, QLocale.Language]) -> str: ...
    ...
    def monthName(self, locale:Union[QLocale, QLocale.Language], month:int, year:int=..., format:QLocale.FormatType=...) -> str: ...
    def monthsInYear(self, year:int) -> int: ...
    def name(self) -> str: ...
    def partsFromDate(self, date:QDate) -> QCalendar.YearMonthDay: ...
    def standaloneMonthName(self, locale:Union[QLocale, QLocale.Language], month:int, year:int=..., format:QLocale.FormatType=...) -> str: ...
    def standaloneWeekDayName(self, locale:Union[QLocale, QLocale.Language], day:int, format:QLocale.FormatType=...) -> str: ...
    def weekDayName(self, locale:Union[QLocale, QLocale.Language], day:int, format:QLocale.FormatType=...) -> str: ...
...
class QCborArray(Shiboken.Object):
    ...
    def __add__(self, v:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QCborArray: ...
    @staticmethod
    def __copy__() -> None: ...
    def __iadd__(self, v:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QCborArray: ...
    def __lshift__(self, v:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QCborArray: ...
    def append(self, value:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def at(self, i:int) -> QCborValue: ...
    def clear(self) -> None: ...
    def compare(self, other:QCborArray) -> int: ...
    def contains(self, value:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> bool: ...
    def empty(self) -> bool: ...
    ...
    def insert(self, i:int, value:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def isEmpty(self) -> bool: ...
    def last(self) -> QCborValue: ...
    def pop_back(self) -> None: ...
    def pop_front(self) -> None: ...
    def prepend(self, value:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def push_back(self, t:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def push_front(self, t:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
...
class QCborMap(Shiboken.Object):
    ...
    @overload
    def contains(self, key:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> bool: ...
    def empty(self) -> bool: ...
    @staticmethod
    ...
    @overload
    def remove(self, key:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def size(self) -> int: ...
    ...
    @overload
    def take(self, key:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QCborValue: ...
    def toCborValue(self) -> QCborValue: ...
    ...
    @overload
    def value(self, key:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QCborValue: ...
...
class QCborValue(Shiboken.Object):
    ...
    @overload
    def __init__(self, other:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    @overload
    ...
    @overload
    def __init__(self, t_:QCborKnownTags, tv:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]=...) -> None: ...
    @overload
    def __init__(self, t_:QCborValue.Type) -> None: ...
    @overload
    def __init__(self, tag:QCborTag, taggedValue:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]=...) -> None: ...
    @overload
    ...
    @staticmethod
    def __copy__() -> None: ...
    def compare(self, other:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> int: ...
    @overload
    @staticmethod
    def fromCbor(ba:Union[QByteArray, bytes], error:Optional[QCborParserError]=...) -> QCborValue: ...
    @overload
    @staticmethod
    def fromCbor(data:bytes, len:int, error:Optional[QCborParserError]=...) -> QCborValue: ...
    @overload
    @staticmethod
    def fromCbor(data:bytearray, len:int, error:Optional[QCborParserError]=...) -> QCborValue: ...
    @overload
    @staticmethod
    def fromCbor(reader:QCborStreamReader) -> QCborValue: ...
    @staticmethod
    def fromJsonValue(v:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QCborValue: ...
    @staticmethod
    ...
    def swap(self, other:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> None: ...
    def tag(self, defaultValue:QCborTag=...) -> QCborTag: ...
    def taggedValue(self, defaultValue:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]=...) -> QCborValue: ...
    @overload
    ...
    def toRegularExpression(self, defaultValue:Union[QRegularExpression, str]=...) -> QRegularExpression: ...
...
class QCryptographicHash(Shiboken.Object):
    ...
    @staticmethod
    def hash(data:Union[QByteArray, bytes], method:QCryptographicHash.Algorithm) -> QByteArray: ...
    @staticmethod
...
class QDataStream(QIODeviceBase):
    ...
    @overload
    def __lshift__(self, arg__2:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QDataStream: ...
    @overload
    def __lshift__(self, arg__2:Union[QEasingCurve, QEasingCurve.Type]) -> QDataStream: ...
    @overload
    def __lshift__(self, arg__2:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QDataStream: ...
    @overload
    ...
    @overload
    def __lshift__(self, combination:Union[QKeyCombination, Qt.KeyboardModifiers, Qt.Key]) -> QDataStream: ...
    @overload
    ...
    @overload
    def __rshift__(self, arg__2:Union[QCborValue, QCborKnownTags, QCborSimpleType, QCborTag, QCborValue.Type, str, QByteArray, QCborArray, QCborMap, bytes, float, int]) -> QDataStream: ...
    @overload
    def __rshift__(self, arg__2:Union[QEasingCurve, QEasingCurve.Type]) -> QDataStream: ...
    @overload
    def __rshift__(self, arg__2:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QDataStream: ...
    @overload
    ...
    @overload
    def __rshift__(self, combination:Union[QKeyCombination, Qt.KeyboardModifiers, Qt.Key]) -> QDataStream: ...
    @overload
...
class QDateTime(Shiboken.Object):
    ...
    @overload
    @staticmethod
    def fromSecsSinceEpoch(secs:int, spec:Qt.TimeSpec=..., offsetFromUtc:int=...) -> QDateTime: ...
    @overload
    @staticmethod
...
class QDeadlineTimer(Shiboken.Object):
    ...
    @overload
    def __init__(self, QDeadlineTimer:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]) -> None: ...
    @overload
    ...
    @overload
    def __sub__(self, dt2:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]) -> int: ...
    @overload
    def __sub__(self, msecs:int) -> QDeadlineTimer: ...
    def _q_data(self) -> Tuple[int, int]: ...
    @staticmethod
    def addNSecs(dt:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int], nsecs:int) -> QDeadlineTimer: ...
    @staticmethod
    ...
    def swap(self, other:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]) -> None: ...
...
class QDir(Shiboken.Object):
    ...
    @overload
    def __init__(self, path:Union[str, bytes, os.PathLike], nameFilter:str, sort:QDir.SortFlags=..., filter:QDir.Filters=...) -> None: ...
    ...
    @overload
    def entryInfoList(self, filters:QDir.Filters=..., sort:QDir.SortFlags=...) -> List[QFileInfo]: ...
    @overload
    def entryInfoList(self, nameFilters:Sequence[str], filters:QDir.Filters=..., sort:QDir.SortFlags=...) -> List[QFileInfo]: ...
    @overload
    def entryList(self, filters:QDir.Filters=..., sort:QDir.SortFlags=...) -> List[str]: ...
    @overload
    def entryList(self, nameFilters:Sequence[str], filters:QDir.Filters=..., sort:QDir.SortFlags=...) -> List[str]: ...
    @overload
...
class QDirIterator(Shiboken.Object):
    ...
    @overload
    def __init__(self, path:str, nameFilters:Sequence[str], filters:QDir.Filters=..., flags:QDirIterator.IteratorFlags=...) -> None: ...
...
class QEasingCurve(Shiboken.Object):
    ...
    @staticmethod
    def __copy__() -> None: ...
    def addCubicBezierSegment(self, c1:Union[QPointF, QPoint], c2:Union[QPointF, QPoint], endPoint:Union[QPointF, QPoint]) -> None: ...
    def addTCBSegment(self, nextPoint:Union[QPointF, QPoint], t:float, c:float, b:float) -> None: ...
...
class QFile(QFileDevice):
    ...
    @overload
    @staticmethod
    def setPermissions(filename:Union[str, bytes, os.PathLike], permissionSpec:QFileDevice.Permissions) -> bool: ...
    @overload
...
class QItemSelection(Shiboken.Object):
    ...
    @overload
    def __init__(self, topLeft:Union[QModelIndex, QPersistentModelIndex], bottomRight:Union[QModelIndex, QPersistentModelIndex]) -> None: ...
    ...
    def reserve(self, size:int) -> None: ...
    def resize(self, size:int) -> None: ...
    def select(self, topLeft:Union[QModelIndex, QPersistentModelIndex], bottomRight:Union[QModelIndex, QPersistentModelIndex]) -> None: ...
    def shrink_to_fit(self) -> None: ...
    def size(self) -> int: ...
    @overload
...
class QItemSelectionModel(QObject):
    ...
    def columnIntersectsSelection(self, column:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    ...
    def isColumnSelected(self, column:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    def isRowSelected(self, row:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    def isSelected(self, index:Union[QModelIndex, QPersistentModelIndex]) -> bool: ...
    def model(self) -> QAbstractItemModel: ...
    def reset(self) -> None: ...
    def rowIntersectsSelection(self, row:int, parent:Union[QModelIndex, QPersistentModelIndex]=...) -> bool: ...
    @overload
    ...
    def setCurrentIndex(self, index:Union[QModelIndex, QPersistentModelIndex], command:QItemSelectionModel.SelectionFlags) -> None: ...
...
class QItemSelectionRange(Shiboken.Object):
    ...
    @overload
    def __init__(self, topL:Union[QModelIndex, QPersistentModelIndex], bottomR:Union[QModelIndex, QPersistentModelIndex]) -> None: ...
    ...
    def contains(self, index:Union[QModelIndex, QPersistentModelIndex]) -> bool: ...
    @overload
    def contains(self, row:int, column:int, parentIndex:Union[QModelIndex, QPersistentModelIndex]) -> bool: ...
    def height(self) -> int: ...
    def indexes(self) -> List[int]: ...
...
class QJsonArray(Shiboken.Object):
    ...
    def __add__(self, v:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QJsonArray: ...
    @staticmethod
    def __copy__() -> None: ...
    def __iadd__(self, v:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QJsonArray: ...
    def __lshift__(self, v:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> QJsonArray: ...
    def append(self, value:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def at(self, i:int) -> QJsonValue: ...
    def contains(self, element:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> bool: ...
    def count(self) -> int: ...
    def empty(self) -> bool: ...
    ...
    def insert(self, i:int, value:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def isEmpty(self) -> bool: ...
    def last(self) -> QJsonValue: ...
    def pop_back(self) -> None: ...
    def pop_front(self) -> None: ...
    def prepend(self, value:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def push_back(self, t:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def push_front(self, t:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def removeAt(self, i:int) -> None: ...
    def removeFirst(self) -> None: ...
    def removeLast(self) -> None: ...
    def replace(self, i:int, value:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    def size(self) -> int: ...
...
class QJsonDocument(Shiboken.Object):
    ...
    @staticmethod
    def fromJson(json:Union[QByteArray, bytes], error:Optional[QJsonParseError]=...) -> QJsonDocument: ...
    @staticmethod
...
class QJsonValue(Shiboken.Object):
    ...
    @overload
    def __init__(self, other:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    @overload
    def __init__(self, s:str) -> None: ...
    @overload
    def __init__(self, s:bytes) -> None: ...
    ...
    def isString(self) -> bool: ...
    def isUndefined(self) -> bool: ...
    def swap(self, other:Union[QJsonValue, QJsonValue.Type, QJsonArray, Dict[str, QJsonValue], str, bytes, float, int]) -> None: ...
    @overload
...
class QLineF(Shiboken.Object):
    ...
    def intersects(self, l:Union[QLineF, QLine], intersectionPoint:Union[QPointF, QPoint, NoneType]=...) -> Tuple: ...
    def isNull(self) -> bool: ...
...
class QMessageAuthenticationCode(Shiboken.Object):
    ...
    def __init__(self, method:QCryptographicHash.Algorithm, key:Union[QByteArray, bytes]=...) -> None: ...
    ...
    def addData(self, device:QIODevice) -> bool: ...
    @staticmethod
    def hash(message:Union[QByteArray, bytes], key:Union[QByteArray, bytes], method:QCryptographicHash.Algorithm) -> QByteArray: ...
    def reset(self) -> None: ...
    def result(self) -> QByteArray: ...
...
class QMimeDatabase(Shiboken.Object):
    ...
    @overload
    def mimeTypeForFileNameAndData(self, fileName:str, data:Union[QByteArray, bytes]) -> QMimeType: ...
    @overload
...
class QObject(Shiboken.Object):
    ...
    @overload
    @staticmethod
    def connect(arg__1:QObject, arg__2:bytes, arg__3:Callable, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    @overload
    def connect(self, arg__1:bytes, arg__2:Callable, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    @overload
    def connect(self, arg__1:bytes, arg__2:QObject, arg__3:bytes, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    @overload
    def connect(self, sender:QObject, signal:bytes, member:bytes, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    @overload
    @staticmethod
    def connect(sender:QObject, signal:QMetaMethod, receiver:QObject, method:QMetaMethod, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    @overload
    @staticmethod
    def connect(sender:QObject, signal:bytes, receiver:QObject, member:bytes, type:Qt.ConnectionType=...) -> QMetaObject.Connection: ...
    ...
    @overload
    @staticmethod
    def disconnect(sender:QObject, signal:QMetaMethod, receiver:QObject, member:QMetaMethod) -> bool: ...
    @overload
    @staticmethod
    ...
    def findChild(self, type:type, name:str=..., options:Qt.FindChildOptions=...) -> object: ...
    @overload
    def findChildren(self, type:type, name:str=..., options:Qt.FindChildOptions=...) -> Iterable: ...
    @overload
    def findChildren(self, type:type, pattern:Union[QRegularExpression, str], options:Qt.FindChildOptions=...) -> Iterable: ...
...
class QProcess(QIODevice):
    ...
    @overload
    def start(self, program:str, arguments:Sequence[str]=..., mode:QIODeviceBase.OpenMode=...) -> None: ...
...
class QPropertyAnimation(QVariantAnimation):
    ...
    def __init__(self, parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, target:QObject, propertyName:Union[QByteArray, bytes], parent:Optional[QObject]=...) -> None: ...
...
class QRectF(Shiboken.Object):
    ...
    @overload
    def __init__(self, topleft:Union[QPointF, QPoint], bottomRight:Union[QPointF, QPoint]) -> None: ...
    @overload
...
class QRegularExpression(Shiboken.Object):
    ...
    @overload
    def globalMatch(self, subject:str, offset:int=..., matchType:QRegularExpression.MatchType=..., matchOptions:QRegularExpression.MatchOptions=...) -> QRegularExpressionMatchIterator: ...
    @overload
    ...
    def isValid(self) -> bool: ...
    @overload
    def match(self, subject:str, offset:int=..., matchType:QRegularExpression.MatchType=..., matchOptions:QRegularExpression.MatchOptions=...) -> QRegularExpressionMatch: ...
    @overload
...
class QSettings(QObject):
    ...
    @overload
    def __init__(self, fileName:str, format:QSettings.Format, parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, format:QSettings.Format, scope:QSettings.Scope, organization:str, application:str=..., parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, organization:str, application:str=..., parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, scope:QSettings.Scope, organization:str, application:str=..., parent:Optional[QObject]=...) -> None: ...
    @overload
...
class QSocketNotifier(QObject):
    ...
    @overload
    def __init__(self, arg__1:object, arg__2:QSocketNotifier.Type, parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, arg__1:QSocketNotifier.Type, parent:Optional[QObject]=...) -> None: ...
    @overload
    def __init__(self, socket:int, arg__2:QSocketNotifier.Type, parent:Optional[QObject]=...) -> None: ...
...
class QSortFilterProxyModel(QAbstractProxyModel):
    ...
    @overload
    def setFilterRegularExpression(self, regularExpression:Union[QRegularExpression, str]) -> None: ...
...
class QStandardPaths(Shiboken.Object):
    ...
    @staticmethod
    def locateAll(type:QStandardPaths.StandardLocation, fileName:str, options:QStandardPaths.LocateOptions=...) -> List[str]: ...
    @staticmethod
...
class QTextBoundaryFinder(Shiboken.Object):
    ...
    @overload
    def __init__(self, type:QTextBoundaryFinder.BoundaryType, str:str, buffer:Optional[bytes]=..., bufferSize:int=...) -> None: ...
    @overload
...
class QTextStream(QIODeviceBase):
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, array:Union[QByteArray, bytes], openMode:QIODeviceBase.OpenMode=...) -> None: ...
    @overload
    def __init__(self, device:QIODevice) -> None: ...
...
class QThread(QObject):
    ...
    @overload
    def wait(self, deadline:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]=...) -> bool: ...
    @overload
...
class QTimeZone(Shiboken.Object):
    ...
    @overload
    def __init__(self, zoneId:Union[QByteArray, bytes], offsetSeconds:int, name:str, abbreviation:str, territory:QLocale.Country=..., comment:str=...) -> None: ...
    ...
    @overload
    def displayName(self, atDateTime:QDateTime, nameType:QTimeZone.NameType=..., locale:Union[QLocale, QLocale.Language]=...) -> str: ...
    @overload
    def displayName(self, timeType:QTimeZone.TimeType, nameType:QTimeZone.NameType=..., locale:Union[QLocale, QLocale.Language]=...) -> str: ...
    ...
    def territory(self) -> QLocale.Country: ...
    def transitions(self, fromDateTime:QDateTime, toDateTime:QDateTime) -> List[QTimeZone.OffsetData]: ...
    @staticmethod
    def utc() -> QTimeZone: ...
    @overload
    @staticmethod
    ...
    @overload
    @staticmethod
    def windowsIdToDefaultIanaId(windowsId:Union[QByteArray, bytes], territory:QLocale.Country) -> QByteArray: ...
    @overload
    @staticmethod
    def windowsIdToIanaIds(windowsId:Union[QByteArray, bytes]) -> List[QByteArray]: ...
    @overload
    @staticmethod
    def windowsIdToIanaIds(windowsId:Union[QByteArray, bytes], territory:QLocale.Country) -> List[QByteArray]: ...
...
class QTranslator(QObject):
    ...
    @overload
    def load(self, locale:Union[QLocale, QLocale.Language], filename:str, prefix:str=..., directory:str=..., suffix:str=...) -> bool: ...
...
class QUrl(Shiboken.Object):
    ...
    @staticmethod
    def toPercentEncoding(arg__1:str, exclude:Union[QByteArray, bytes]=..., include:Union[QByteArray, bytes]=...) -> QByteArray: ...
...
class QWaitCondition(Shiboken.Object):
    ...
    @overload
    def wait(self, lockedMutex:QMutex, deadline:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]=...) -> bool: ...
    @overload
    def wait(self, lockedMutex:QMutex, time:int) -> bool: ...
    @overload
    def wait(self, lockedReadWriteLock:QReadWriteLock, deadline:Union[QDeadlineTimer, QDeadlineTimer.ForeverConstant, Qt.TimerType, int]=...) -> bool: ...
    @overload
...
class QXmlStreamReader(Shiboken.Object):
    ...
    def addExtraNamespaceDeclarations(self, extraNamespaceDeclaractions:Sequence[QXmlStreamNamespaceDeclaration]) -> None: ...
    def atEnd(self) -> bool: ...
