...
class QFileDialog(QDialog):
    ...
    @staticmethod
    def getOpenFileName(parent:QWidget | None, caption:Optional[str]=..., dir:str=..., filter:str=..., selectedFilter:str=..., options:QFileDialog.Options=...) -> Tuple: ...
    @staticmethod
...
class QMessageBox(QDialog):
    ...
    @overload
    @staticmethod
    def information(parent:QWidget | None, title:str, text:str, buttons:QMessageBox.StandardButtons=..., defaultButton:QMessageBox.StandardButton=...) -> QMessageBox.StandardButton: ...
