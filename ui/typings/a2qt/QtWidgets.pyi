...
class QMenu(QWidget):
    ...
    def addAction(self, arg__1:QtGui.QAction) -> None: ...
    @overload
    def addAction(self, arg__1:str, arg__2:object, arg__3:Union[QtGui.QKeySequence, QtCore.QKeyCombination, QtGui.QKeySequence.StandardKey, str, int, NoneType]=...) -> None: ...
    @overload
    def addAction(self, arg__1:Union[QtGui.QIcon, QtGui.QPixmap], arg__2:str, arg__3:object, arg__4:Union[QtGui.QKeySequence, QtCore.QKeyCombination, QtGui.QKeySequence.StandardKey, str, int, NoneType]=...) -> None: ...
    @overload
