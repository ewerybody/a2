...
Script managing and developing framework for [Autohotkey](http://ahkscript.org/) (currently **Autohotkey_L**) with [PySide](https://wiki.qt.io/PySide) (Python/Qt) frontend.<br>
