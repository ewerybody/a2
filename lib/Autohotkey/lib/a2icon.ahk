...
class A2Icons {
    ...
    static locate => A2Icons.__Get("locate", 0)
    static more => A2Icons.__Get("more", 0)
    static number => A2Icons.__Get("number", 0)
    static paste => A2Icons.__Get("paste", 0)
    static placeholder => A2Icons.__Get("placeholder", 0)
