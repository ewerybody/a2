...
;---     https://www.autohotkey.com/boards/viewtopic.php?f=6&t=29314&start=20	   ---
;-------------------------------------------------------------------------------------
;-------------------------------------------------------------------------------------

; Forum:	https://www.autohotkey.com/boards/viewtopic.php?f=6&t=29314
; From:     https://www.autohotkey.com/boards/viewtopic.php?t=29314
; Look at:	https://tdalon.blogspot.com/2020/02/autohotkey-clipboard-handling.html
;			https://apathysoftworks.com/ahk/index.html
;           https://www.autohotkey.com/board/topic/74670-class-winclip-direct-clipboard-manipulations/

; Alternative: https://www.autohotkey.com/boards/viewtopic.php?t=62156

; Bugfixing look at
;   -> https://www.autohotkey.com/boards/viewtopic.php?t=29314 (WinClipAPI.CloseClipboard() bug and others)
;   -> https://www.autohotkey.com/boards/viewtopic.php?t=71323 (encoding bug)
;   Possible further encoding issues: _loadFiles(); _getFiles(); _saveFiles(); GetRTF() und iGetRTF() still encoding with CP0

; Notices: 
;   This version ist modded at line 400 + X
; 	--> Sleep, 500 ; for extra safety was added.
;
;   Possible further encoding issues: _loadFiles(); _getFiles(); _saveFiles(); GetRTF() und iGetRTF() still encoding with CP0
...
_BITMAPtoDIB_cleanup:
    ...
    iGetHtml(encoding:="UTF-8")
    {
        ...
        if !( out_size := this._getFormatData( out_data, clipData, clipSize, "HTML Format" ) )
            return ""
        return strget( &out_data, out_size, ecoding )
    }
