...
Class CNotifyIcons
{
    Info := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), WinVer >= WIN_Vista ? 222 : 136)
    Error := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), WinVer >= WIN_Vista ? 78 : 110)
    Warning := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), 78)
    Success := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), WinVer >= WIN_Vista ? 145 : 136)
    Internet := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), 136)
    Sound := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\SndVol.exe"), 2)
    SoundMute := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\SndVol.exe"), 3)
    Question := icon_extract(ExpandPathPlaceholders("%WINDIR%\System32\shell32.dll"), 24)
}
