/*
	...
	explorer_get_selected(hwnd="")   - paths of target window's selected items
	explorer_get_all(hwnd="")        - paths of all items in the target window's folder
	explorer_get_path(hwnd="")       - path of target window's folder
